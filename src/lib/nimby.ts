...
export const NIMBY_KINDS: readonly NimbyKind[] = [
  ...
  },
  {
    ...
    exclude: /駐車場|駐輪場|社宅|寮$|清掃工場|パン工場|ケーキ|豆腐|チョコ|工場見学|カフェ|直売|レストラン|ビール醸造|ワイナリー|コーヒー|チーズ|ミルク|スイーツ|バウム|プリン|ジェラート|アイス|ルミネ|店$|ショップ|キッチン|Kitchen|サービス工場|整備|板金|車検|販売|直販|見学/i,
  },
] as const;
