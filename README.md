...
| 嫌悪施設（パチンコ・工場・ガソリンスタンド・風俗・ごみ処理・下水処理・火葬場・墓地/寺・葬儀場・物流・変電所・ガスタンク・畜産）| Google Places Nearby（タイプ）＋ Text Search（12語）→ 名称・業種で分類。課金単価が高いため「⚠️ 嫌悪施設 探す」を押したときだけ取得（半径1.5km） | Google |
